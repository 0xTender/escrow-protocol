export const addresses = {
  "1337": {
    Escrow: "0x7c60eD34D3d00B8D87Bcc4b889e298cD2721cfd0",
    MultiSwapExtension: "0x1f49f78350A0377269b1D0488ee72188B72E4447",
    SwapERC20Extension: "0x16701fE6A80D7752eb7754961e4fB49597083d90",
    TestNFT: "0xaf8d0C1717928779c4B03a2Df0b7D5b3ba426e9e",
...
export const MultiSwapExtensionABI = [
  {
    inputs: [
      {
        internalType: "address",
  ...
  },
  {
    ...
    inputs: [
      ...
      {
        indexed: false,
        internalType: "enum MultiSwapExtension.EscrowState",
        name: "state",
        type: "uint8",
      },
      {
        indexed: false,
        internalType: "enum MultiSwapExtension.ExchangeType",
...
export const SwapERC20ExtensionABI = [
  {
    inputs: [
      {
        internalType: "address",
