...
export interface SwapERC20ForERC721ExtensionInterface extends utils.Interface {
  functions: {
...
export interface SwapERC20ForERC721Extension extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SwapERC20ForERC721ExtensionInterface;
